...
abstract class CBaseListView extends CWidget
{
	...
	/**
	 * @var array|string the configuration for the pager. Defaults to <code>array('class'=>'OLinkPager')</code>.
	 * String value will be treated as the class name of the pager (<code>'ClassName'</code> value is similar
	 * to the <code>array('class'=>'ClassName')</code> value). See {@link CBasePager} and {@link OLinkPager}
